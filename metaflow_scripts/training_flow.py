...
class TrainingFlow(FlowSpec):
    ...
    def start(self):
        ...
        self.filtered_questions, self.filtered_labels = process_data('/Users/lancesanterre/intern_2024/data/cleaned/data.pkl')
    ...
    def register_model(self):
        ...
        mlflow.set_tracking_uri('sqlite:///mlflow.db') #use gcp url
